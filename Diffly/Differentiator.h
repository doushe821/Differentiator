...
void* DiffSum(tree_t* tree, void* Node, FILE* TexOut, VariableTable_t* VarTable);
void* DiffMul(tree_t* tree, void* Node, FILE* TexOut, VariableTable_t* VarTable);
void* DiffDiv(tree_t* tree, void* Node, FILE* TexOut, VariableTable_t* VarTable);
void* DiffVar(tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
void* DiffPow(tree_t* tree, void* Node, FILE* TexOut, VariableTable_t* VarTable);

void* DiffConst(tree_t* tree, __attribute((unused))void* node, __attribute((unused)) FILE* TexOut, VariableTable_t* VarTable);


void* DifferentiateOperation(tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
void* DifferentiateFunction(tree_t* tree , void* node, FILE* TexOut, VariableTable_t* VarTable);
...
void* FDiffSin   (tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
void* FDiffCos   (tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
void* FDiffArcsin(tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
void* FDiffArccos(tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
void* FDiffTg    (tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
void* FDiffCtg   (tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
void* FDiffArctg (tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
void* FDiffArcctg(tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
void* FDiffSh    (tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
void* FDiffCh    (tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
void* FDiffArcsh (tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
void* FDiffArcch (tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
void* FDiffTh    (tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
void* FDiffCth   (tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
void* FDiffArcth (tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
void* FDiffArccth(tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
void* FDiffLn    (tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
void* FDiffLog   (tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
...
struct function
{
    ...
    void* (*FDiffFunc)(tree_t* tree, void* node, FILE* TexOut, VariableTable_t* VarTable);
    int (*TexDumpFunc)(void* node, FILE* out, VariableTable_t* VarTable);
};
